# update_pitchers.py
# 118 pitchers • FIVE buckets (incl. Leadoff_2nd_PA) • starter-only • 0-0 count
...
# ── 1. Pitcher → MLBAM ID mapping (118 total) ──────────────────────────
PITCHERS = {
    "Colin_Rea": 607067, "Paul_Skenes": 694973, "Seth_Lugo": 607625,
    "Simeon_Woods_Richardson": 677943, "Ben_Lively": 594902, "Zack_Wheeler": 554430,
    "David_Peterson": 656849, "Tyler_Anderson": 542881, "Brayan_Bello": 686880,
    ...
    "German_Marquez": 606466, "Luis_Severino": 622663, "Trevor_Williams": 592866,
    "Matthew_Boyd": 571440, "Hunter_Greene": 668881, "Griffin_Canning": 656288,
    "Shane_Smith": 681343, "Landon_Roupp": 677974, "Freddy_Peralta": 642547,
    "Drew_Rasmussen": 656876, "Pablo_Lopez": 642456, "Zac_Gallen": 668678,
    "Cade_Povich": 700249, "Miles_Mikolas": 571945, "AJ_Smith_Shawver": 700363,
    "Tyler_Mahle": 641816, "Cristopher_Sanchez": 665742, "Chris_Sale": 519242,
    "Shane_Baz": 669358, "Emerson_Hancock": 676106, "MacKenzie_Gore": 669022,
    "Zach_Eflin": 621107, "Sean_Burke": 680732, "Taijuan_Walker": 592836,
    "Chris_Bassitt": 605135, "Jeffrey_Springs": 605488, "Luis_Ortiz": 656814,
    "Cal_Quantrill": 615698, "Grant_Holmes": 656550, "Jack_Leiter": 683004,
    "Matthew_Liberatore": 669461, "Casey_Mize": 663554, "Ryan_Pepiot": 686752,
    "Nick_Pivetta": 601713, "Merrill_Kelly": 518876, "Jake_Irvin": 663623,
    "Tony_Gonsolin": 664062, "Max_Fried": 608331, "Nick_Lodolo": 666157,
    "Dean_Kremer": 665152, "Jesus_Luzardo": 666200, "Patrick_Corbin": 571578,
    "Kyle_Hendricks": 543294, "Spencer_Schwellenbach": 680885,
    "Walker_Buehler": 621111, "Kodai_Senga": 673540, "Antonio_Senzatela": 622608,
    ...
    "Sandy_Alcantara": 645261, "Lucas_Giolito": 608337, "Ranger_Suarez": 664561,
    "Logan_Allen": 671106, "Emmet_Sheehan": 686218, "Stephen_Kolek": 663568,
    "Eduardo_Rodriguez": 571561, "Eric_Lauer": 641778, "Spencer_Strider": 675911,
    "Andrew_Heaney": 571760, "Justin_Verlander": 434378, "Shota_Imanaga": 684007
}
...
def tag_leadoff_seq(df: pd.DataFrame) -> pd.DataFrame:
    ...
    for gpk, leadoff_id in leadoff_batters.items():
        mask = (
            (df.game_pk == gpk) &
            (df.batter == leadoff_id) &
            df.first_pitch &
...
for name, pid in PITCHERS.items():
    ...
    # Only games where they started
    started_games = df.loc[(df.inning == 1) & (df.pa_order == 1), "game_pk"].unique()
    df = df[df.game_pk.isin(started_games)]
    if df.empty:
        continue
    ...
    pc = "pitch_name" if "pitch_name" in df.columns else "pitch_type"
    df_out = (
        df[["game_pk", "game_date", "bucket", pc]]
