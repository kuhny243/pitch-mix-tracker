# update_pitchers.py
# 118 pitchers • starter-only • FIVE buckets (0-0 count) • auto-retry
...
PITCHERS = {
    ...
    "Simeon_Woods_Richardson": 680570, "Ben_Lively": 594902,
    "Zack_Wheeler": 554430, "David_Peterson": 656849,
    "Tyler_Anderson": 542881, "Bryan_Bello": 686880, "Andrew_Abbott": 671096,
    "Sonny_Gray": 543243, "Jose_Berrios": 640455, "Mitch_Keller": 656605,
    "Ben_Brown": 676962, "Kyle_Freeland": 607536, "Framber_Valdez": 664285,
    "Jose_Soriano": 660716, "Bryan_Woo": 693433, "Brandon_Pfaadt": 694297,
    "Kevin_Gausman": 592332, "Tanner_Bibee": 676440, "Brady_Singer": 663903,
    "Carlos_Rodon": 607074, "Bowden_Francis": 670102, "German_Marquez": 608566,
    "Luis_Severino": 622663, "Trevor_Williams": 592866, "Matthew_Boyd": 621242,
    "Hunter_Greene": 668881, "Griffin_Canning": 656288, "Shane_Smith": 681343,
    "Landon_Roupp": 681925, "Freddy_Peralta": 642547, "Drew_Rasmussen": 656876,
    "Pablo_Lopez": 622694, "Zac_Gallen": 668678, "Cade_Povich": 700249,
    "Miles_Mikolas": 571945, "AJ_Smith_Shawver": 700363, "Tyler_Mahle": 641816,
    "Cristopher_Sanchez": 666382, "Chris_Sale": 519242, "Shane_Baz": 669358,
    ...
    "Hunter_Brown": 686613, "Jameson_Taillon": 592791, "Yoshinobu_Yamamoto": 808967,
    "Max_Meyer": 676974, "Logan_Webb": 657277, "Joe_Ryan": 657746,
    "Dustin_May": 669160, "Mitchell_Parker": 680730, "Charlie_Morton": 119424,
    "Nick_Martinez": 605288, "Taj_Bradley": 671737, "Chris_Paddack": 663978,
    "Luis_Castillo": 664057, "Tomoyuki_Sugano": 608372, "Chase_Dollander": 801403,
    "Tylor_Megill": 656731, "Michael_Lorenzen": 547179, "Jose_Quintana": 500779,
    "Andre_Pallante": 669467, "Hunter_Dobbins": 690928, "Sandy_Alcantara": 645261,
    "Lucas_Giolito": 608337, "Ranger_Suarez": 664761, "Logan_Allen": 671106,
    "Emmet_Sheehan": 686218, "Stephen_Kolek": 663568, "Eduardo_Rodriguez": 621203,
    "Eric_Lauer": 641778, "Spencer_Strider": 675911, "Andrew_Heaney": 571760,
...
def mark_first_pitch(df: pd.DataFrame) -> pd.DataFrame:
    """Flag the first *thrown* pitch of each PA (skips pick‐offs/disengagements)."""
...
def add_leadoff_seq(df: pd.DataFrame) -> pd.DataFrame:
    df["leadoff_seq"] = -1
    first_rows = df[(df.inning == 1) & (df.pa_order == 1) & df.first_pitch
                    & (df.balls == 0) & (df.strikes == 0)]
    lead_ids = first_rows.groupby("game_pk")["batter"].first()

    for gpk, b_id in lead_ids.items():
        mask = (df.game_pk == gpk) & (df.batter == b_id) & df.first_pitch \
               & (df.balls == 0) & (df.strikes == 0)
...
for name, pid in PITCHERS.items():
    ...
    starter_games = df.loc[(df.inning == 1) & (df.pa_order == 1),
                           "game_pk"].unique()
    ...
    detail = (df[["game_pk", "game_date", "bucket", pitch_col]]
